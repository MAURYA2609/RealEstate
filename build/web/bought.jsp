...
<br>
        <%
            ...
            try{
                   ...
                   PreparedStatement pst = conn.prepareStatement("select * from home where buyer=? ");
        ...
        %>
                   <center>
                    ...
                    <p class="m"> This house is bought from :<%=rs.getString("seller")%> in <%=rs.getString("price")%> ₹</p>
                   </center>
                <%}
